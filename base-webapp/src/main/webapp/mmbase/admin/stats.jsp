...
%>
<%@ page import="org.mmbase.util.HttpServletRequestUtils" %>
...
<mm:import id="thisserver"><%= HttpServletRequestUtils.getServerName(request) %><%=request.getContextPath().replaceAll("/", "_") %></mm:import>
#
